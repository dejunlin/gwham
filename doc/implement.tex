...
in my implementation in the following sections. \change{Note that the 
purpose of this section is not to elaborate the details of my implementation
, as I don't and will not have the intention/time of doing so, 
but to provide a general understanding of how my implementation works or
how one could potentially implement their own WHAM program}. 
...
\subsection{Minimizing $F$ in equation~\ref{eq:Fexg}}
...
\subsection{Solve equation~\ref{eq:WHAM1}}
